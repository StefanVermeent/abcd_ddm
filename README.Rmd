...
```{r figure1, fig.width=6, fig.height = 2.5, dpi=600, fig.id = "figure1", fig.cap.style = "Image Caption", fig.cap='**Figure 1.** Graphical overview of the data access workflow using R and GitHub.'}
...
1.  `registered_report/scripts/staging.R`: Reads and combines all the relevant analysis objects generated by the analysis scripts and combines them in a list for the supplemental materials.
1.  `registered_report/registered_report.qmd`: loads the staged results list and knits together the supplemental materials and all statistics, tables, and figures computed in previous scripts.

### 5. Supplement

1.  `supplement/scripts/staging_suppl.R`: Reads and combines all the relevant analysis objects generated by the analysis scripts and combines them in a list for the supplemental materials.

...
```{r figure1, fig.width=3, dpi=600, fig.id = "figure1", fig.cap.style = "Image Caption", fig.cap='**Figure 1.** Graphical overview of the data access workflow using R and GitHub.'}

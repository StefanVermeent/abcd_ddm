...
Relatedly, @bignardi_2023 found that raw Flanker and Attention Shifting performance---after accounting for general processes---was negatively associated with SES in the ABCD sample (i.e., youth from lower SES performing relatively better).

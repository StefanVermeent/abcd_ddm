...
Different types of adversity pose different challenges and constraints, and therefore shape developing cognitive abilities in diverse ways
[@blair_2012]. 
...
Threat and deprivation have been widely studied in their relation to cognitive outcomes from both deficit and adaptation perspectives [e.g., @bignardi_2022; @fields_2021; @schafer_2022; @sheridan_2022; @young_2022] and are at the center of contemporary conceptualizations of adversity [e.g., @mclaughlin_2021; @sheridan_2014].
However, it remains an open question as to whether and how each adversity dimension shapes individual differences in youth's cognitive processing.
...
In line with adaptation-based theories [@frankenhuis_2013; @frankenhuis_2016; @ellis_2022] and empirical findings by @bignardi_2022, we predict that any enhancements in cognitive abilities as a result of adverse experiences will manifest on a task-specific level, but not on a task-general level.
In contrast, deficit patterns may emerge on both a task-general and task-specific level.
As very little is known about the effects of adversity on different stages of cognitive processing, we refrain from predicting specific patterns for different DDM parameters.
However, we will interpret associations between the types of adversity and DDM parameters as follows:
For drift rates, positive associations will be interpreted as *better* speed of information processing at higher levels of adversity, and negative associations as *worse* speed of information processing.
Task-specific drift rates will be interpreted as specific cognitive abilities, as the drift rate reflects the efficiency with which a task was completed.
For non-decision time, positive associations will be interpreted as *worse* (i.e., slower) task preparation and execution at higher levels of adversity, and negative associations will be interpreted as *better* (i.e., faster) task-preparation and execution.
For boundary separation, positive associations will be interpreted as more cautious responding at higher levels of adversity, and negative associations as less cautious responding.

...
hbayes_sim_500 <- choiceRT_ddm(
  data = hbayes_simdata_rt %>% filter(n == 500), niter = 4000, nwarmup = 1000, nchain = 4, ncore = 3
)

hbayes_sim_1000 <- choiceRT_ddm(
  data = hbayes_simdata_rt %>% filter(n == 1000), niter = 4000, nwarmup = 1000, nchain = 4, ncore = 3
)

hbayes_sim_5000 <- choiceRT_ddm(
  data = hbayes_simdata_rt %>% filter(n == 5000), niter = 4000, nwarmup = 1000, nchain = 4, ncore = 3
)

hbayes_sim_10000 <- choiceRT_ddm(
  data = hbayes_simdata_rt %>% filter(n == 10000), niter = 4000, nwarmup = 1000, nchain = 4, ncore = 3
)

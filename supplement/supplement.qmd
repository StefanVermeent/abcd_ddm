...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S3. **Convergence of the model in simulation 1. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S4. **Parameter recovery in the case of two conditions. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S5. **Convergence of the model in simulation 2. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S6. **Parameter recovery in the case of two conditions. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S7. **Convergence of the model in simulation 3. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S8.**Parameter recovery in the case of two conditions. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate
...
Figure S9 shows signs of shrinkage, especially in the right tail of the drift rate distribution.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S9.**Histograms of simulated and recovered parameter estimates. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate.
staged_sim_results_supp$ddm_sim4_hist

```
<br>

Next, we calculated the deviations between each simulated and recovered parameter estimate and plotted this against the adversity scores (See Figure S10).
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S10.**Deviation between simulated and recovered parameter estimates as a function of adversity. The regression lines show quadratic effects. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate.
...
As Figure 11 illustrates, there seemed to be small shrinkage effects at the low and high levels of adversity.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S11.**Simple slopes of the difference between simulated and estimated drift rates at different levels of adversity.
...
A fit overview for all DDM models is presented in Table S2-S5. 
As described in the main article, we deviated from our preregistered fit procedure by simulating 100 trials per task instead of the same amount as the observed trials.
These results are presented in Table S2. 
We also present the results using the original, preregistered approach in Table S3.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S12.** Convergence of the final model for the Mental Rotation Task. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S13.** Convergence of the final model for the Inhibition Task. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S14.** Convergence of the final model for the Attention Shifting Task. Plots should resemble a 'fat, hairy caterpillar'.
...
#| dpi: 600
#| fig-cap: | 
#|   **Figure S15.** Convergence of the final model for the Processing Speed Task. Plots should resemble a 'fat, hairy caterpillar'.

...
```{r figureS10, fig.width=6, fig.height = 3, dpi=600, fig.id = "figureS10", fig.cap.style = "Image Caption", fig.cap='**Figure S10.** Deviation between simulated and recovered parameter estimates as a function of adversity. The regression lines show quadratic effects. a = Boundary Separation; t = Non-Decision Time; v = Drift Rate'}
...
```{r figureS11, fig.width=6, fig.height = 3, dpi=600, fig.id = "figureS11", fig.cap.style = "Image Caption", fig.cap='**Figure S11.** Simple slopes of the difference between simulated and estimated drift rates at different levels of adversity.'}

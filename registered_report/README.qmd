...
*I am contemplating adding an exploratory analysis looking at associations with raw performance measures (using simple linear regression models) to provide context for the results in Figure 5.*
